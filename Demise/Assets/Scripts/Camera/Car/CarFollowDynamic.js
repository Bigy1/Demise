...
@script AddComponentMenu("Scripts/Camera/Car/Follow Dynamic")
...
function FixedUpdate() {
	...
	if(Physics.Raycast(CarTransform.position, (CameraPosition - CarTransform.position).normalized, hit, CameraDisplacement.magnitude + 0.125, 9))
		CameraPosition = (CameraPosition - CarTransform.position).normalized * (CameraDisplacement.magnitude - 0.125);
